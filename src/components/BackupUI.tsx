...
export default function BackupUI() {
  ...
  async function onClickInitializeBackup() {
    if (space && bluesky.userProfile && bluesky.agent && storacha.client) {
      await storacha.client.setCurrentSpace(space.did())
      setCurrentBackupId(
        await initializeBackup(bluesky.userProfile, backupMetadataStore)
      )
    }
  }
  ...
  return userAuthenticatedToBothServices ? (
    <div>
      {space ? (
            ...
            <div className="flex flex-row items-center my-2 space-x-8">
              ...
              {isBackingUpRepo ? (
                ...
                <button
                  ...
                  disabled={!space || isBackingUpRepo}
        ...
        <div>
          <p>
            Please choose the Storacha space where you&apos;d like to back up
        ...
        <div>
          You are logged in to Storacha, but we could not find any Storacha
          Spaces - please create one using the CLI or Storacha Web Console and
